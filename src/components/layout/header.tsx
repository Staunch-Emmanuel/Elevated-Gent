                          ...
                          if (link.href === '/articles') {
                            return (
                              ...
                              >
                                <Link
                                  href={link.href}
                                  className="group relative h-7 overflow-hidden text-decoration-none transition-all duration-300 ease-in-out hover:scale-105 cursor-pointer whitespace-nowrap inline-block"
                                >
                                ...
                                <div className="absolute left-1/2 top-full z-[1200] hidden -translate-x-1/2 pt-4 group-hover:block">
                                  <div className="min-w-[240px] rounded-xl border border-gray-200 bg-white p-2 shadow-xl">
                                    ...
                                    {ARTICLE_NAV_CATEGORIES.map((item) => (
                                      <Link
                                        key={item.href}
                                        href={item.href}
                                        className="block rounded-lg px-4 py-3 text-sm font-serif text-black transition-colors hover:bg-gray-50"
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className="group flex w-full items-center justify-between p-4 rounded-lg transition-all duration-200 ease-in-out hover:bg-gray-50 cursor-pointer text-left"
                        >
                          <span className="font-serif text-lg group-hover:text-black transition-colors">
                            {link.name}
                          </span>
                          <svg
                            className={`w-4 h-4 text-gray-400 transition-all duration-200 ${isArticlesMenuOpen ? 'rotate-90 text-black' : 'group-hover:text-black'}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <div className={`overflow-hidden transition-all duration-300 ${isArticlesMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                          <div className="pl-4 pb-2">
                            <Link
                              href="/articles"
                              onClick={closeMobileMenu}
                              className="block p-3 rounded-lg text-base font-serif text-gray-700 hover:bg-gray-50 hover:text-black transition-colors"
                            >
                              All Articles
                            </Link>
