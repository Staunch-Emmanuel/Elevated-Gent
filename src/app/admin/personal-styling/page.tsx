          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {[
              ...
              return (
                <section
                  key={packageKey}
                  className="space-y-5 border border-[#817E6C] bg-[#E8EBEC] p-6 shadow-[0_12px_32px_rgba(36,35,29,0.05)]"
                >
                  <h2 className="font-editorial text-2xl font-normal text-[#24231d]">
                    {label}
                  </h2>
            ...
            <div className="sticky bottom-4 z-20 border border-[#817E6C] bg-[rgba(232,235,236,0.96)] p-4 shadow-[0_16px_42px_rgba(36,35,29,0.16)] backdrop-blur-xl">
              <button
                type="submit"
                disabled={saving}
